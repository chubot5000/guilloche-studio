...
const description =
  "Design adjustable guilloché medallions, spirographs, woven borders, ribbons, moiré fields, wave hatching, globes, and torus meshes, then export press-ready vector SVGs.";
